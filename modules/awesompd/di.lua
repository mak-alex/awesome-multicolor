...
local di =
   { api_key = "65ee7704ca677f1ec8ff5d01", -- https://di.fm/ --- Get premium account and paste your api_key
     stream_url_fmt = "http://prem2.di.fm:80/%s?%s",
...
function di.get_link(full_link)
   return string.match(full_link, "https?://prem%d+.di.fm:80/([%w%d]+).+")
end
