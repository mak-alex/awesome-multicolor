...
theme.taglist_bg_empty    = "#333333" .. theme.icons .. "/panel/taglist/empty.png"
theme.taglist_bg_occupied = "#333333" --"png:" .. theme.icons .. "/panel/taglist/occupied.png"
theme.taglist_bg_urgent   = "" --"png:" .. theme.icons .. "/panel/taglist/urgent.png"
theme.taglist_bg_focus    = "#0f1717" --"png:" .. theme.icons .. "/panel/taglist/focus.png"
