...
theme.taglist_bg_empty    = "#b8b8b8" --"png:" .. theme.icons .. "/panel/taglist/empty.png"
theme.taglist_bg_occupied = "#b8b8b8" --"png:" .. theme.icons .. "/panel/taglist/occupied.png"
theme.taglist_bg_urgent   = "#3F3F3F" --"png:" .. theme.icons .. "/panel/taglist/urgent.png"
theme.taglist_bg_focus    = "#888888" -- "png:" .. theme.icons .. "/panel/taglist/focus.png"
