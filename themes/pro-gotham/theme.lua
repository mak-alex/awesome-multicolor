...
theme.border_normal = "#74aeab"
theme.border_focus  = "#1a4b5c"
...
theme.menu_border_color="#99d1ce"
...
theme.taglist_bg_empty    = "#0d1217" --"png:" .. theme.icons .. "/panel/taglist/empty.png"
theme.taglist_bg_occupied = "#0d1217" --"png:" .. theme.icons .. "/panel/taglist/occupied.png"
theme.taglist_bg_urgent   = ""--"png:" .. theme.icons .. "/panel/taglist/urgent.png"
theme.taglist_bg_focus    = "#1a4b5c" --"png:" .. theme.icons .. "/panel/taglist/focus.png"
