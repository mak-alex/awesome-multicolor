...
theme.taglist_bg_empty    = "#3F3F3F" --"png:" .. theme.icons .. "/panel/taglist/empty.png"
theme.taglist_bg_occupied = "#535353" --"png:" .. theme.icons .. "/panel/taglist/occupied.png"
theme.taglist_bg_urgent   = "#3F3F3F" --"png:" .. theme.icons .. "/panel/taglist/urgent.png"
theme.taglist_bg_focus    = "#5a5a5a" -- "png:" .. theme.icons .. "/panel/taglist/focus.png"
